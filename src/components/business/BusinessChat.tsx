...
export default function BusinessChat({ bookingId, isOpen, onClose, customerName }: BusinessChatProps) {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={`Chat with ${customerName}`} size="lg">
