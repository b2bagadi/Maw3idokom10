...
export default function BusinessCard({ business }: BusinessCardProps) {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border dark:border-gray-700 overflow-hidden hover:shadow-md transition-all group">
            ...
            <div className="p-4">
                <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="flex items-center bg-yellow-100 dark:bg-yellow-900/30 px-1.5 py-0.5 rounded text-yellow-700 dark:text-yellow-500 text-sm font-bold">
                        ...
                        <span className="text-gray-400 font-normal ml-1">({business._count?.reviews})</span>
                    </div>
                </div>
