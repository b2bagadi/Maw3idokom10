                    ...
                    if (bookRes.ok) {
                        ...
                        if (Array.isArray(bookings)) {
                            ...
                            results.push(...pending.map((b: any) => ({
                                id: 'booking-' + b.id,
                                title: t('notification.newBooking', { defaultValue: 'New Booking' }),
                    ...
                    {session ? (
                        <div className="flex items-center gap-3">
                            ...
                            <div className="relative">
                                ...
                                {/* Dropdown */}
                                {showNotifications && (
                                    <div ref={notificationsRef} className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-xl shadow-lg border dark:border-gray-700 overflow-hidden">
                                        ...
                                        <div className="max-h-64 overflow-y-auto">
                                            {notifications.length > 0 ? (
                                                notifications.map((n: any) => (
                                                    <div key={n.id} className="p-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 cursor-pointer border-b dark:border-gray-700/50 last:border-0">
